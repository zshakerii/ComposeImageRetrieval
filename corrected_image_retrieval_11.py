...
def build_clip_image_cache(
    ...
    for image_id in tqdm(image_ids, desc="CLIP image embeddings"):
        image_path = find_image_path(image_folder, image_id)
        if image_path is None:
            print(f"[WARN] Image path not found for gallery ID: {image_id}")
            continue
        ...
        try:
            ...
            print(f"[WARN] Could not open image {image_id} at {image_path}: {exc}")
            continue
